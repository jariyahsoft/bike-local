...
class BranchesApi {
  ...
  Future<Response<InlineObject2>> createBranch({ 
    ...
    final _path = r'/stores/{store_id}/branches'.replaceAll('{' r'store_id' '}', encodeQueryParameter(_serializers, storeId, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(CreateBranchRequest);
      _bodyData = _serializers.serialize(createBranchRequest, specifiedType: _type);
  ...
  Future<Response<InlineObject2>> getBranch({ 
    ...
    final _path = r'/branches/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xCorrelationId != null) r'X-Correlation-Id': xCorrelationId,
  ...
  Future<Response<InlineObject2>> updateBranch({ 
    ...
    try {
      const _type = FullType(UpdateBranchRequest);
      _bodyData = _serializers.serialize(updateBranchRequest, specifiedType: _type);
