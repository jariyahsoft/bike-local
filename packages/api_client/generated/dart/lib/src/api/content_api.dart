...
class ContentApi {
  ...
  Future<Response<ApproveContentSubmission200Response>> approveContentSubmission({ 
    ...
    final _path = r'/content-submissions/{id}/approve'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    ApproveContentSubmission200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApproveContentSubmission200Response),
      ) as ApproveContentSubmission200Response;
    ...
    return Response<ApproveContentSubmission200Response>(
      data: _responseData,
  ...
  Future<Response<CreatePlace201Response>> createPlace({ 
    ...
    try {
      const _type = FullType(Place);
      _bodyData = _serializers.serialize(place, specifiedType: _type);
    ...
    CreatePlace201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreatePlace201Response),
      ) as CreatePlace201Response;
    ...
    return Response<CreatePlace201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<CreateRoute201Response>> createRoute({ 
    ...
    CreateRoute201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateRoute201Response),
      ) as CreateRoute201Response;
    ...
    return Response<CreateRoute201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
