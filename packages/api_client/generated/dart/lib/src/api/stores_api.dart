...
class StoresApi {
  ...
  Future<Response<InlineObject1>> createStore({ 
    ...
    try {
      const _type = FullType(CreateStoreRequest);
      _bodyData = _serializers.serialize(createStoreRequest, specifiedType: _type);
  ...
  Future<Response<InlineObject1>> decideStoreApproval({ 
    ...
    final _path = r'/stores/{id}/approval-decisions'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xCorrelationId != null) r'X-Correlation-Id': xCorrelationId,
    ...
    try {
      const _type = FullType(StoreApprovalDecisionRequest);
      _bodyData = _serializers.serialize(storeApprovalDecisionRequest, specifiedType: _type);
  ...
  Future<Response<InlineObject1>> submitStore({ 
    ...
    final _path = r'/stores/{id}/submit'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xCorrelationId != null) r'X-Correlation-Id': xCorrelationId,
    ...
    try {
      const _type = FullType(SubmitStoreRequest);
      _bodyData = _serializers.serialize(submitStoreRequest, specifiedType: _type);
  ...
  Future<Response<InlineObject1>> updateStore({ 
    ...
    final _path = r'/stores/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        if (xCorrelationId != null) r'X-Correlation-Id': xCorrelationId,
    ...
    try {
      const _type = FullType(UpdateStoreRequest);
      _bodyData = _serializers.serialize(updateStoreRequest, specifiedType: _type);
