...
class ReturnApi {
  ...
  Future<Response<InlineObject7>> acceptReturnRequest({
    ...
    final _path = r'/return-requests/{id}/accept'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(ReturnInspection);
      _bodyData = _serializers.serialize(returnInspection, specifiedType: _type);
  ...
  Future<Response<InlineObject7>> createReturnRequest({
    ...
    try {
      const _type = FullType(CreateReturnRequest);
      _bodyData = _serializers.serialize(createReturnRequest, specifiedType: _type);
