...
class HandoverApi {
  ...
  Future<Response<InlineObject4>> handoverBooking({
    ...
    final _path = r'/bookings/{id}/handover'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(HandoverRequest);
      _bodyData = _serializers.serialize(handoverRequest, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InlineObject4),
      ) as InlineObject4;
