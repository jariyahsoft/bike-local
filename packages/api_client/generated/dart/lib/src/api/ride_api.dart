...
class RideApi {
  ...
  Future<Response<InlineObject6>> createRideSession({
    ...
    try {
      const _type = FullType(CreateRideSessionRequest);
      _bodyData = _serializers.serialize(createRideSessionRequest, specifiedType: _type);
    ...
    InlineObject6? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InlineObject6),
      ) as InlineObject6;
  ...
  Future<Response<InlineObject6>> endRideSession({
    ...
    final _path = r'/ride-sessions/{id}/end'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Idempotency-Key': idempotencyKey,
    ...
    try {
      const _type = FullType(EndRideSessionRequest);
      _bodyData = _serializers.serialize(endRideSessionRequest, specifiedType: _type);
  ...
  Future<Response<UploadRideTrackChunk202Response>> uploadRideTrackChunk({
    ...
    final _path = r'/ride-sessions/{id}/chunks'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Idempotency-Key': idempotencyKey,
    ...
    UploadRideTrackChunk202Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UploadRideTrackChunk202Response),
      ) as UploadRideTrackChunk202Response;
    ...
    return Response<UploadRideTrackChunk202Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
