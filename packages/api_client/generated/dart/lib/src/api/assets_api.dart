...
class AssetsApi {
  ...
  Future<Response<CheckAvailability200Response>> checkAvailability({ 
    ...
    final _path = r'/availability/check';
    ...
    try {
      const _type = FullType(AvailabilityCheckRequest);
      _bodyData = _serializers.serialize(availabilityCheckRequest, specifiedType: _type);
    ...
    CheckAvailability200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CheckAvailability200Response),
      ) as CheckAvailability200Response;
    ...
    return Response<CheckAvailability200Response>(
      data: _responseData,
  ...
  Future<Response<CreateAssetCategory201Response>> createAssetCategory({ 
    ...
    final _path = r'/asset-categories';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Idempotency-Key': idempotencyKey,
    ...
    try {
      const _type = FullType(CreateAssetCategoryRequest);
      _bodyData = _serializers.serialize(createAssetCategoryRequest, specifiedType: _type);
    ...
    CreateAssetCategory201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateAssetCategory201Response),
      ) as CreateAssetCategory201Response;
    ...
    return Response<CreateAssetCategory201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<CreateEquipmentItem201Response>> createEquipmentItem({ 
    ...
    try {
      const _type = FullType(CreateEquipmentItemRequest);
      _bodyData = _serializers.serialize(createEquipmentItemRequest, specifiedType: _type);
    ...
    CreateEquipmentItem201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateEquipmentItem201Response),
      ) as CreateEquipmentItem201Response;
    ...
    return Response<CreateEquipmentItem201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<CreateInventoryUnit201Response>> createInventoryUnit({ 
    ...
    try {
      const _type = FullType(CreateInventoryUnitRequest);
      _bodyData = _serializers.serialize(createInventoryUnitRequest, specifiedType: _type);
    ...
    CreateInventoryUnit201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateInventoryUnit201Response),
      ) as CreateInventoryUnit201Response;
    ...
    return Response<CreateInventoryUnit201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<InlineObject3>> updateAsset({ 
    ...
    final _path = r'/assets/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        if (xCorrelationId != null) r'X-Correlation-Id': xCorrelationId,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(updateAssetRequest, specifiedType: _type);
