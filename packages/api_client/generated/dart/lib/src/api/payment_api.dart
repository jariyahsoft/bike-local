...
class PaymentApi {
  ...
  Future<Response<InlineObject5>> confirmCashPayment({ 
    ...
    final _path = r'/bookings/{id}/cash-confirmations'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(CashConfirmationRequest);
      _bodyData = _serializers.serialize(cashConfirmationRequest, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InlineObject5),
      ) as InlineObject5;
  ...
  Future<Response<ProcessPaymentWebhook202Response>> processPaymentWebhook({ 
    ...
    final _path = r'/payment-webhooks/{provider}'.replaceAll('{' r'provider' '}', encodeQueryParameter(_serializers, provider, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Idempotency-Key': idempotencyKey,
