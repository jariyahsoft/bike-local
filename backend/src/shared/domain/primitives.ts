...
export type PaymentEventId = DomainId<"PaymentEvent">;
export type DepositId = DomainId<"Deposit">;
export type SettlementId = DomainId<"Settlement">;
export type ReportExportId = DomainId<"ReportExport">;
export type OutboxEventId = DomainId<"OutboxEvent">;
export type RideSessionId = DomainId<"RideSession">;
export type ReturnRequestId = DomainId<"ReturnRequest">;
export type SosCaseId = DomainId<"SosCase">;
export type NotificationId = DomainId<"Notification">;
export type NotificationDeviceId = DomainId<"NotificationDevice">;
export type NotificationDeliveryLogId = DomainId<"NotificationDeliveryLog">;
export type ContentSubmissionId = DomainId<"ContentSubmission">;
export type ContentReportId = DomainId<"ContentReport">;
export type RouteId = DomainId<"Route">;
export type PlaceId = DomainId<"Place">;
export type ReviewId = DomainId<"Review">;
